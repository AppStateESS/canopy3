...
class Dashboard
{
    ...
    /**
     * Loads the dashboard.json file in the resource/dashboards/ directory.
     *
     * @return boolean
     */
    private function load()
    {
        $dashboardPath = C3_DASHBOARDS_DIR . 'dashboard.json';
    ...
    public static function register($dashboardName)
    {
